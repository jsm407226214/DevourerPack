...
Ig = Class(function(self, ingredienttype, amount, atlas, deconstruct, imageoverride) end)
...
player.HUD:ShowPopupNumber(damage, large and 48 or 32, t:GetPosition(), 40, COLOUR, large)
