...
config.upgrade_effects = {
    ...
    walrushat = { kw = 30, dapperness = 1 },  -- 贝雷帽/Tam o' Shanter
    ...
    slurtlehat = { defense = 0.05, snail = 1 },  -- 背壳头盔/Shelmet
    ...
    ruinshat = { defense = 0.05, forcefield = true, ruins = 1, overlord = 1 },       -- 铥矿皇冠/Thulecite Crown
    ...
    hivehat = { defense = 0.05, dapperness = 1, saresistance = 0.1,devourer_bee = true, insect = true }, -- 蜂王冠/Bee Queen Crown
    ...
    eyemaskhat = { defense = 0.05, hunger_rate = 0.1, terraria = 1 }, -- 眼面具/Eye Mask
    cookiecutterhat = { defense = 0.05, basereflect = 5, aoereflect = 1 }, -- 饼干切割机帽子/Cookie Cutter Cap
    ...
    eyebrellahat = { waterproof = 0.5, insulated = true, kc = 30, saresistance = 0.1, firedreduction = 0.25, season = 1 }, -- 眼球伞/Eyebrella


    gelblob_bottle = { preserver = 0.1 },                  -- 恶液罐/Icker Jar
    gelblob_storage_kit = { preserver = 0.1, add_slot_cols = 1, except = "gelblob_storage" }, -- 恶液储存箱套件/Icker Preserve Kit
    gelblob_storage = { no_move = true, preserver = 0.1, add_slot_cols = 1, except = "gelblob_storage_kit" }, -- 恶液储存箱/Icker Preserve
    ...
    deserthat = { goggles = true },          -- 沙漠护目镜/Desert Goggles
    ...
    spiderhat = { creep = true, spiderdisguise = true }, -- 蜘蛛帽/Spiderhat
    ...
    antlionhat = { walksinkhole = true }, -- 刮地皮头盔/Turf-Raiser Helm
    ...
    monkey_smallhat = { master_crewman = true },     -- 海盗头巾/Pirate's Bandana
    monkey_mediumhat = { boat_health_buffer = true },     -- 船长的三角帽/Captain's Tricorn
...
config.food_effects = {
    baconeggs = { hunger = 1.1, hp = 0.5, carnivore = 1 },  -- 培根煎蛋/Bacon and Eggs
    bananajuice = { hunger = 0.5, hp = 0.3, sanity = 0.7, vegetarian = 1 },  -- 香蕉奶昔/Banana Shake
    bananapop = { kc = 5, hunger = 0.3, hp = 0.5, sanity = 0.7, vegetarian = 1 },  -- 香蕉冻/Banana Pop
    barnaclepita = { hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 藤壶皮塔饼/Barnacle Pita
    barnaclestuffedfishhead = { hunger = 1.1, hp = 0.5, carnivore = 1 },  -- 酿鱼头/Stuffed Fish Heads
    barnaclesushi = { hunger = 0.7, hp = 0.8, sanity = 0.4, carnivore = 1 },  -- 藤壶握寿司/Barnacle Nigiri
    barnaclinguine = { hunger = 1.1, hp = 0.6, sanity = 0.5, vegetarian = 1 },  -- 藤壶中细面/Barnacle Linguine
    bonestew = { hunger = 1.7, hp = 0.4, carnivore = 1 },  -- 炖肉汤/Meaty Stew
    bunnystew = { hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 炖兔子/Bunny Stew
    butterflymuffin = { hunger = 0.7, hp = 0.5, vegetarian = 1 },  -- 蝴蝶松饼/Butter Muffin
    californiaroll = { hunger = 0.7, hp = 0.5, sanity = 0.3, carnivore = 1 },  -- 加州卷/California Roll
    ceviche = { hunger = 0.5, hp = 0.5, carnivore = 1 },  -- 酸橘汁腌鱼/Ceviche
    dragonpie = { hunger = 1.1, hp = 0.8, vegetarian = 1 },  -- 火龙果派/Dragonpie
    figatoni = { hunger = 0.9, hp = 0.6, sanity = 0.4, carnivore = 1 },  -- 无花果意面/Figatoni
    figkabab = { hunger = 0.7, hp = 0.5, sanity = 0.3, carnivore = 1 },  -- 无花果烤串/Figkabab
    fishsticks = { hunger = 0.7, hp = 0.8, carnivore = 1 },  -- 炸鱼排/Fishsticks
    fishtacos = { hunger = 0.7, hp = 0.5, carnivore = 1 }, -- 鱼肉玉米卷/Fish Tacos
    flowersalad = { hunger = 0.3, hp = 0.8, vegetarian = 1 },  -- 花沙拉/Flower Salad
    frogglebunwich = { hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 蛙腿三明治/Froggle Bunwich
    frognewton = { hunger = 0.5, hp = 0.5, carnivore = 1 },  -- 无花果蛙腿三明治/Figgy Frogwich
    frozenbananadaiquiri = { hunger = 0.4, hp = 0.6, sanity = 0.4, vegetarian = 1 },  -- 冰香蕉冻唇蜜/Frozen Banana Daiquiri
    fruitmedley = { hunger = 0.5, hp = 0.5, vegetarian = 1 },  -- 水果圣代/Fruit Medley
    guacamole = { hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 鳄梨酱/Guacamole
    honeyham = { hunger = 1.1, hp = 0.6, carnivore = 1 },  -- 蜜汁火腿/Honey Ham
    honeynuggets = { hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 蜜汁卤肉/Honey Nuggets
    hotchili = { kw = 5, hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 辣椒炖肉/Spicy Chili
    icecream = { hunger = 0.5, sanity = 1.0, vegetarian = 1 }, -- 冰淇淋/Ice Cream 
    jammypreserves = { hunger = 0.7, vegetarian = 1 }, -- 果酱/Fist Full of Jam 
    justeggs = { hunger = 0.8, carnivore = 1 },  -- 普通煎蛋/Plain Omelette
    kabobs = { hunger = 0.7, carnivore = 1 },  -- 肉串/Kabobs
    koalefig_trunk = { hunger = 1.7, hp = 1.0, sanity = 0.4, carnivore = 1 },  -- 无花果酿象鼻/Fig-Stuffed Trunk
    leafloaf = { hunger = 0.7, hp = 0.3, vegetarian = 1 },  -- 叶肉糕/Leafy Meatloaf
    leafymeatburger = { hunger = 0.7, hp = 0.6, sanity = 0.7, vegetarian = 1 },  -- 素食堡/Veggie Burger
    leafymeatsouffle = { hunger = 0.7, sanity = 1.0, vegetarian = 1, carnivore = 1 },  -- 果冻沙拉/Jelly Salad
    lobsterbisque = { hunger = 0.5, hp = 1.0, sanity = 0.3, carnivore = 1 },  -- 龙虾浓汤/Lobster Bisque
    lobsterdinner = { hunger = 0.7, hp = 1.0, sanity = 1.0, carnivore = 1 },  -- 龙虾正餐/Lobster Dinner
    mandrakesoup = { sleep_res = 1, hunger = 1.7, hp = 1.4, vegetarian = 1 },  -- 曼德拉草汤/Mandrake Soup
    mashedpotatoes = { hunger = 0.7, hp = 0.5, sanity = 0.7, vegetarian = 1 },  -- 奶油土豆泥/Creamy Potato Purée
    meatballs = { hunger = 0.9, carnivore = 1 },  -- 肉丸/Meatballs
    meatysalad = { hunger = 1.1, hp = 0.8, vegetarian = 1 },  -- 牛肉绿叶菜/Beefy Greens
    monsterlasagna = { hunger = 0.7, carnivore = 1 },  -- 怪物千层面/Monster Lasagna
    pepperpopper = { hunger = 0.5, hp = 0.6, vegetarian = 1 },  -- 爆炒填馅辣椒/Stuffed Pepper Poppers
    perogies = { hunger = 0.7, hp = 0.8 },  -- 波兰水饺/Pierogi
    potatotornado = { hunger = 0.7, sanity = 0.4, vegetarian = 1 },  -- 花式回旋块茎/Fancy Spiralled Tubers
    pumpkincookie = { hunger = 0.7, sanity = 0.4, vegetarian = 1 },  -- 南瓜饼干/Pumpkin Cookies
    ratatouille = { hunger = 0.5, vegetarian = 1 },  -- 蔬菜杂烩/Ratatouille
    salsa = { hunger = 0.5, sanity = 0.7, vegetarian = 1 },  -- 生鲜萨尔萨酱/Salsa Fresca
    seafoodgumbo = { hunger = 0.7, hp = 0.8, sanity = 0.5, carnivore = 1 },  -- 海鲜浓汤/Seafood Gumbo
    shroombait = { sleep_res = 1, hunger = 0.4, vegetarian = 1 }, -- 酿夜帽/Stuffed Night Cap 
    shroomcake = { sleep_res = 1, hunger = 0.5, sanity = 0.3, vegetarian = 1 },  -- 蘑菇蛋糕/Mushy Cake
    stuffedeggplant = { hunger = 0.7, vegetarian = 1 },  -- 酿茄子/Stuffed Eggplant
    surfnturf = { hunger = 0.7, hp = 1.0, sanity = 0.7, carnivore = 1 },  -- 海鲜牛排/Surf 'n' Turf
    taffy = { hunger = 0.5, sanity = 0.4, vegetarian = 1 }, -- 太妃糖/Taffy
    talleggs = { hunger = 1.7, hp = 1.0, carnivore = 1 },  -- 苏格兰高鸟蛋/Tall Scotch Eggs
    turkeydinner = { hunger = 1.1, hp = 0.5, carnivore = 1 },  -- 火鸡正餐/Turkey Dinner
    unagi = { hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 鳗鱼料理/Unagi
    veggieomlet = { hunger = 0.7, hp = 0.5, carnivore = 1 },  -- 早餐锅/Breakfast Skillet
    vegstinger = { hunger = 0.5, sanity = 0.7, vegetarian = 1 },  -- 蔬菜鸡尾酒/Vegetable Stinger
    waffles = { hunger = 0.7, hp = 1.0, vegetarian = 1 },  -- 华夫饼/Waffles
    asparagussoup = { hunger = 0.4, hp = 0.5, vegetarian = 1 },  -- 芦笋汤/Asparagus Soup
    watermelonicle = { hunger = 0.3, sanity = 0.5, vegetarian = 1 },  -- 西瓜冰棍/Melonsicle
    trailmix = { hunger = 0.3, hp = 0.6, vegetarian = 1 },  -- 什锦干果/Trail Mix

    -- 大厨料理,加成翻倍
    frogfishbowl = { hunger = 1.3, hp = 1.0, cookperson = 1 }, -- 蓝带鱼排/Fish Cordon Bleu
    voltgoatjelly = { hunger = 1.3, sanity = 0.7, externaldamage = 0.01, cookperson = 1 }, -- 伏特羊肉冻/Volt Goat Chaud-Froid
    dragonchilisalad = { hunger = 1.0, sanity = 0.7, kw = 10, cookperson = 1 }, -- 辣龙椒沙拉/Hot Dragon Chili Salad
    gazpacho = { hunger = 1.0, sanity = 0.7, kc = 10, cookperson = 1 }, -- 芦笋冷汤/Asparagazpacho
    glowberrymousse = { hunger = 1.3, sanity = 0.7, light = 0.3, cookperson = 1 }, -- 发光浆果慕斯/Glow Berry Mousse
    moqueca = { hunger = 2.7, hp = 2.0, sanity = 1.5, cookperson = 1 }, -- 海鲜杂烩/Moqueca
    bonesoup = { hunger = 3.3, hp = 1.3, cookperson = 1 }, -- 骨头汤/Bone Bouillon
    monstertartare = { hunger = 1.9, cookperson = 1 }, -- 怪物鞑靼/Monster Tartare
    potatosouffle = { hunger = 1.3, hp = 1.0, sanity = 0.9, cookperson = 1 }, -- 蓬松土豆蛋奶酥/Puffed Potato Soufflé
    freshfruitcrepes = { hunger = 3.3, hp = 2.0, sanity = 0.9, cookperson = 1 }, -- 鲜果可丽饼/Fresh Fruit Crepes
    nightmarepie = { sanity = 1.0, hp = 1.0, cookperson = 1 }, -- 恐怖国王饼/Grim Galette

    -- 特殊食物，固定加成
    powcake = { hunger = 0.2, vegetarian = 1 },  -- 芝士蛋糕/Powdercake
    ...
    jellybean = { hp = 1, health = 0.1, vegetarian = 1 },  -- 彩虹糖豆/Jellybeans
...
config.alchemy_change_items_array = {
    ...
    "alterguardianhat","eyemaskhat","shieldofterror","scrap_monoclehat","spiderhat","malbatross_beak","fruitflyfruit","hivehat","blowdart_pipe","walrushat", -- 装备
}
